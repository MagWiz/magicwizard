...
void Tile::loadTiles()
{
     ...
     if ( !textureB0.loadFromFile ( "assets/gfx/back/tree_1.png" ) )
          exit ( 1 );
     if ( !textureB1.loadFromFile ( "assets/gfx/back/sign_2.png" ) )
          exit ( 1 );
     if ( !textureB2.loadFromFile ( "assets/gfx/back/bush_1.png" ) )
          exit ( 1 );
     if ( !textureB3.loadFromFile ( "assets/gfx/back/bush_2.png" ) )
          exit ( 1 );
     ...
     backgroundTextures.push_back ( textureB0 );
     backgroundTextures.push_back ( textureB1 );
     backgroundTextures.push_back ( textureB2 );
     backgroundTextures.push_back ( textureB3 );
...
void Tile::addObject ( int lineX, int lineY, int tileType )
{
     ...
     spritegroundTmp.setTexture ( backgroundTextures[tileType] );
     ...
     backgroundObjects.push_back ( spritegroundTmp );
     lineX = 0;
     lineY = 0;
}
               ...
               for ( unsigned int lineCol = 0; lineCol < line.size(); lineCol++ ) {
                    ...
                    if ( ( lineSize > 0 ) && ( lastChar == 'W' ) && ( compar != 'W' ) ) {
                         ...
                         if ( compar == '*' ) {
                              ...
                              addObject ( lineCol, lineY, MWEngine::B0_SIGN1 );
                         }

                         else if ( compar == '}' ) {
                              addObject ( lineCol, lineY, MWEngine::B1_SIGN2 );
                         }

                         else if ( compar == ';' ) {
                              addObject ( lineCol, lineY, MWEngine::B2_BUSH1 );
                         } else if ( compar == ':' ) {
                              addObject ( lineCol, lineY, MWEngine::B3_BUSH2 );
                         }
...
void Tile::moveLeft ( float deltaTime, float characterSpeed )
{
     ...
     for ( std::vector<MagicSprite>::reverse_iterator it = backgroundObjects.rbegin(); it != backgroundObjects.rend(); ++it ) {
          MagicSprite spriteValue = *it;
          spriteValue.move ( tileGroundSpeed * deltaTime * characterSpeed, -0.f );
          *it = spriteValue;
     }
